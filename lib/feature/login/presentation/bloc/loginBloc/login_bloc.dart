  ...
  Future<void> _onLoginPressed(
    ...
    try {
      ...
      if (user.status == "true") {
        ...
        await prefs.setString(PrefKeys.clientId, user.data.first.clientid);
        await prefs.setString(PrefKeys.userId, user.data.first.id);
        await prefs.setString(PrefKeys.userName, user.data.first.name);
        await prefs.setString(PrefKeys.mobile, user.data.first.mobile);
