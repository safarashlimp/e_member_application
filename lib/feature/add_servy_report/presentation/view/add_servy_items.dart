...
//                                                      // ✅ Bloc error inside border
//                 errorText: showRationCardError ? ' ' : null,
...
class _AddServyItemsState extends State<AddServyItems> {
  ...
  void _handleSubmit(BuildContext context) {
    setState(() {
      ...
      showRationCardError = selectedRationCardId == null;
    });

    if (!_formKey.currentState!.validate() || selectedRationCardId == null) {
      // Show error snackbar
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
