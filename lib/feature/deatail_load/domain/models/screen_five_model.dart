...
import 'dart:convert';
WelfareResponse screen2ModelFromJson(String str) => WelfareResponse.fromJson(json.decode(str));
...
class WelfareResponse {
  ...
  factory WelfareResponse.fromJson(Map<String, dynamic> json) {
    return WelfareResponse(
      status: json['Status'],
      data: List<WelfareModel>.from(json["data"].map((x) => WelfareModel.fromJson(x))),
    );
