...
//         providers: [
//           // 🔹 Only page-specific bloc
//           BlocProvider(
//             create: (_) => FamilyMemberDetailLoadBloc(
...
class _MemberCardState extends State<MemberCard> {
  ...
  void onViewTap(BuildContext context, PageMode mode) async {
          ...
          Row(
            ...
            children: [
              SizedBox(
                ...
                height: 23,
                child: OutlinedButton.icon(
                  onPressed: _isNavigating ? null : () => onViewTap(context, PageMode.view),
              ...
              SizedBox(
                ...
                height: 23,
                child: OutlinedButton.icon(
                  onPressed: _isNavigating ? null : () => onViewTap(context, PageMode.edit),
