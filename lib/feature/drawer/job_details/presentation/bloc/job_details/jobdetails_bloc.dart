...
class JobDetailsDrawerBloc
    extends Bloc<JobDetailsDrawerEvent, JobDetailsDrawerState> {
  final JobDrawerRepository _repository;

  JobDetailsDrawerBloc(this._repository)
      : super(const JobDetailsDrawerState()) {
  ...
  void _onOptionSelected(
    ...
    switch (event.stepIndex) {
      ...
      case 2: // തൊഴിൽ മേഖലയിൽ സഹായം
        updatedFilter =
            state.filter.copyWith(needEmploymentHelp: event.optionId);
        break;
      default:
        return;
    }
