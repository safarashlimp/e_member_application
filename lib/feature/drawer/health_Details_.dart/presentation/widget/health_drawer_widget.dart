...
import '../../domain/entity/health_drawer_filter.dart';
import '../bloc/bloc/health_detail_drawer_event.dart';

class HealthDrawerWidget {
...
static   Widget buildStepsSection(BuildContext context, HealthDrawerState state) {
    return Container(
  ...
  static  bool _hasSelectionForStep(HealthDrawerFilter filter, int step) {
    switch (step) {
      case 0:
