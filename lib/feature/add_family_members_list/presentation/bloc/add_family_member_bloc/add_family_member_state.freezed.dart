...
part of 'add_family_member_state.dart';
...
class _$InitialImpl implements Initial {
  ...
  @override
  String toString() {
    return 'AddFamilyMemberState.initial()';
  }
...
abstract class Initial implements AddFamilyMemberState {
...
class _$LoadingImpl implements Loading {
  ...
  @override
  String toString() {
    return 'AddFamilyMemberState.loading()';
  }
...
abstract class Loading implements AddFamilyMemberState {
...
class _$ErrorImpl implements Error {
  ...
  @override
  String toString() {
    return 'AddFamilyMemberState.error(failure: $failure)';
  }
...
abstract class Error implements AddFamilyMemberState {
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(this.detailId);
  ...
  @override
  String toString() {
    return 'AddFamilyMemberState.loaded(detailId: $detailId)';
  }
...
abstract class Loaded implements AddFamilyMemberState {
  const factory Loaded(final int detailId) = _$LoadedImpl;
